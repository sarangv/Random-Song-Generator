...
public class Extension_Activity extends AppCompatActivity implements View.OnClickListener{

    private final int WHOLE_NOTE = 1000;
    private final int HALF_NOTE = 500;
    private final int QUARTER_NOTE = 250;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(Extension_Activity.this);

        button2 = (Button) findViewById(R.id.button2);
        button2.setOnClickListener(Extension_Activity.this);

        button3 = (Button) findViewById(R.id.button3);
        button3.setOnClickListener(Extension_Activity.this);

        button5 = (Button) findViewById(R.id.button5);
        button5.setOnClickListener(Extension_Activity.this);
    ...
    private void Song6(){  //mary had a little lamb
        try{
            mpA.start();
            delayPlaying(HALF_NOTE);
            mpA.seekTo(0);
    ...
    private void Song7(){  //hot cross buns
        try{
            mpE.start();
            delayPlaying(HALF_NOTE);
            mpE.seekTo(0);
